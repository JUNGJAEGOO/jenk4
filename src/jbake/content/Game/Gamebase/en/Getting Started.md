...
[TOAST Cloud Console]에서 <strong>[Game] > [Gamebase]</strong> 상품을 선택한 후 ##[상품 이용]## 버튼을 클릭하여 서비스를 활성화 합니다.
...
![appid](http://static.toastoven.net/prod_gamebase/Server_Developers_Guide/pre_appId_v1.1.png)
[그림2] Gamebase AppId
...
![check](http://static.toastoven.net/prod_gamebase/Server_Developers_Guide/pre_secret_key_v1.1.png)
[그림3] Gamebase SecretKey

### Register App and Client [Console]
Gamebase Console의 [앱] 메뉴를 이용하여 게임 및 클라이언트의 기본 정보를 등록합니다.
각 항목의 자세한 설명은 아래 링크를 참고하시기 바랍니다.
* LINK [Operator Guide > App] : App 설정정보
* LINK [Operator Guide > Client] : Client 설정정보
...
LINK [Download Gamebase SDK]
SDK 다운로드 후 플랫폼별 자세한 설정 방법은 각 플랫폼별 [Developers Guide]를 참고하시기 바랍니다.
* LINK [iOS 개발프로젝트 설정하기]
* LINK [Android 개발프로젝트 설정하기]
* LINK [Unity Plug-in 개발프로젝트 설정하기] 
...
* LINK [iOS Developer's Guide]
* LINK [Android Developer's Guide]
* LINK [Unity Developer's Guide]

### Server Developer's Guide
* LINK [Server Developer's Guide]

### Operator's Guide
* LINK [Operator's Guide]
