...
![image](http://static.toastoven.net/prod_realtimemultiplayer/img_31.jpg)
...
![image](http://static.toastoven.net/prod_realtimemultiplayer/img_32.jpg)

## SDK 다운로드

SDK를 내려받아 프로젝트에 추가해야 합니다. SDK는 [DOCUMENTS] > [Download]에서 내려받을 수 있습니다. 다음과 같이 SDK와 함께 샘플 프로젝트, 샘플 프로그램이 같이 제공됩니다.

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_33.jpg)

## SDK 추가

내려받은 SDK를 유니티 프로젝트에 추가합니다.

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_34.jpg)

## NetworkManager 추가

임의의 GameObject를 생성해서 다음과 같이 인스펙터에서 NetworkManager Component를 추가합니다.

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_35.jpg)

## URL과 Appkey 입력

앞에서 확인한 URL과 Appkey를 NetworkManager의 인스팩터에 입력합니다.

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_36.jpg)

## 설정

현재 씬을 연결이 끊어졌을 때 호출될 씬으로 지정하고 네트워크 연결 상태일 때 사용될 씬을 생성해서 [File] > [Build Settings]에 등록합니다.

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_37.jpg)

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_38.jpg)

Network Manager의 인스펙터에서 다음과 같이 등록합니다.

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_39.jpg)
...
![image](http://static.toastoven.net/prod_realtimemultiplayer/img_40.jpg)

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_41.jpg)

유니티 에디터에서 [Edit] > [Play]를 클릭하면 게임 화면에서 다음과 같이 확인할 수 있습니다.

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_42.jpg)

UserID에 플레이어를 구분할 수 있는 고유 아이디를 입력하고 Connect 버튼을 클릭하면 Online Scene항목에 지정한 씬이 호출되고 게임 화면이 다음과 같이 변경됩니다.

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_43.jpg)

Disconnect 버튼을 클릭하면 Offline Scene에 지정한 씬으로 변경됩니다.

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_44.jpg)

## 동시 접속 확인

Console에서 리얼 타임 멀티플레이어의 동시 접속 사용자는 다음과 같이 확인할 수 있습니다.

![image](http://static.toastoven.net/prod_realtimemultiplayer/img_45.jpg)
