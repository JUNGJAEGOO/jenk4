...
status=published
big=TCNotification
summary=PushClientSDKv1.32
~~~~~~
## Notification > Push > Client SDK Developer's Guide
이전 버전보기: <select onchange="location.href=this.value">
<option value="../../../Notification/Push/ko/Client SDK Guide.html">v1.4</option>
<option selected value="../../../Notification/Push/ko/Client SDK Guide v1.32.html">v1.32</option></select>
