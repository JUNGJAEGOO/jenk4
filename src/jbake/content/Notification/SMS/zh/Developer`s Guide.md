...
이전 버전보기 :   <select onchange="location.href=this.value"><option selected value="../../../Notification/SMS/zh/Developer%60s%20Guide.html">API v2.0</option><option value="../../../Notification/SMS/zh/Developer%60s%20Guide_v1.html">API v1.0</option></select>
